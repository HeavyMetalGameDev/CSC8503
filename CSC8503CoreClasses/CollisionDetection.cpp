...
bool CollisionDetection::RayOBBIntersection(const Ray& r, const Transform& worldTransform, const OBBVolume& volume, RayCollision& collision) {
	//we must transform the ray to be in box local space
...
bool CollisionDetection::RaySphereIntersection(const Ray& r, const Transform& worldTransform, const SphereVolume& volume, RayCollision& collision) {
	...
	// direction between ray and sphere
	Vector3 dir = (spherePos - r.GetPosition());

	// then project sphere's origin to the ray direction vector
...
bool CollisionDetection::AABBSphereIntersection(const AABBVolume& volumeA, const Transform& worldTransformA,
	...
	Vector3 closestPointOnBox = Maths::Vec3Clamp(delta, -boxSize, boxSize);
...
bool  CollisionDetection::OBBSphereIntersection(const OBBVolume& volumeA, const Transform& worldTransformA,
	...
	Vector3 localSpherePosition = worldTransformA.GetPosition() - worldTransformB.GetPosition();
	Transform localSphereTransform;
	localSphereTransform.SetPosition((invTransform * localSpherePosition) + worldTransformA.GetPosition());
...
bool CollisionDetection::OBBCapsuleIntersection( //----------------------------------------------------fix this
	...
	if (collided) {
		...
		collisionInfo.point.localB = transform * -collisionInfo.point.localA;
		collisionInfo.point.normal = transform * -collisionInfo.point.normal;
	}
	return collided;
}
...
bool CollisionDetection::SphereCapsuleIntersection(
	...
	Vector3 clampSphere = Maths::Vec3Clamp(spherePos, capMin, capMax);

	//Debug::DrawLine(clampSphere, spherePos);
	...
	newSphereTransform.SetPosition(clampSphere);
