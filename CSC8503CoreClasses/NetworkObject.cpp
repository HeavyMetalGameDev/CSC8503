...
bool NetworkObject::WriteClientPacket(GamePacket** p,ClientInputComponent* c) {
	...
	cp->buttonstates[0] = c->buttoninputs[0];
	cp->buttonstates[1] = c->buttoninputs[1];
	cp->buttonstates[2] = c->buttoninputs[2];
	cp->buttonstates[3] = c->buttoninputs[3];
	cp->buttonstates[4] = c->buttoninputs[4];
	cp->buttonstates[5] = c->buttoninputs[5];
	cp->buttonstates[6] = c->buttoninputs[6];
	cp->buttonstates[7] = c->buttoninputs[7];
